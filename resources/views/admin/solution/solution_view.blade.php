    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        <input type="text" name="title" value="{{ $solution_view->title }}" disabled="">
       @if ($errors->has('title')) 
        ...
        @endif 
                ...
                <div class="form-group">
                            <label>Banner Image: </label>
                             <img src="{{ asset('public/images/admin/solution/banner/'.$solution_view->banner_image) }}" class="tt">
                        </div>
                        <div class="form-group">
                            <label>Alt Banner Image: </label>
                            <input type="text" name="alt_banner_image" value="{{$solution_view->alt_banner_image}}" disabled="">
                        </div>

        <div class="form-group">
            <label>Price: </label>
            <input type="text" name="price" value="{{$solution_view->price}}" disabled="">
        ...
        <textarea rows="4" cols="50" name="description" disabled="" class="disabled"> {{ $solution_view->description }} </textarea>
       @if ($errors->has('description')) 
        ...
        <div class="form-group">
            <label>Image: </label>
            <img src="{{ asset('public/images/admin/solution/'.$solution_view->image) }}" class="tt">
        </div>
          <div class="form-group">
        <label>Alt Image: </label>
        <input type="text" name="image_alt" value="{{$solution_view->image_alt}}" disabled="">
        </div>

     <!--    <div class="form-group">
            <label> Product Features: </label>              
            <textarea rows="4" cols="50" name="product_features" disabled=""> {{$solution_view->product_features}}</textarea>
            
        </div>

        <div class="form-group">
            <label> Available Cast-In-Place Tile Sizes And Prices: </label>             
            <textarea rows="4" cols="50" name="size_price" disabled=""> {{$solution_view->size_price}}</textarea>
            
        </div>

        <div class="form-group">
            <label> Application: </label>               
            <textarea rows="4" cols="50" name="application" disabled="">{{$solution_view->application}}</textarea>
        ...
        <input type="text" name="meta_title" value="{{ $solution_view->meta_title }}" disabled="">
       @if ($errors->has('meta_title')) 
        ...
        <textarea rows="4" cols="50" name="meta_description" disabled=""> {{ $solution_view->meta_description }} </textarea>
        ...
        <input type="text" name="meta_keyword" value="{{ $solution_view->meta_keyword }}" disabled="">
