    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        @include('partials/admin/msg')
         <form name="s_category_add" method="post" action="{{ route('category-save')}}"  enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-10">
    ...
    <div class="togglebtn toggle-click">      
       ...
       <div class="form-group">
        <label>Solution: </label>
          ...
          <option value="{{$solutions->id}}">{{$solutions->title}}</option>
          @endforeach
        </select>
     ...
     <!--    <select  name="csc_category" >
      ...
      <!--   <div class="form-group">
                <label>Solution: </label>
                <div class="cstm-checkbox color">
                   @foreach($solution as $solutions)                     
                    <div class="cust-test">
                    <input type="checkbox" name="solution[]" value="{{$solutions->id}}">{{$solutions->title}}                
                    </div>
                    @endforeach 
