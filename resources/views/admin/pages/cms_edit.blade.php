    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        <form name="cms_update" method="post" action="{{ route('cms_update')}}" enctype="multipart/form-data">
        ...
        <input type="text" name="page_name" value="@if ($errors->has('page_name')){{old('page_name')}}@else{{$CsmEdit->page_name}}@endif">
        ...
        @endif
         ...
         <div class="form-group">
        <label class="col-md-4">Alt Image: </label>
        ...
        <textarea class="form-control custm-height" name="meta_description">@if($errors->has('meta_description')){{old('meta_description')}}@else{{$CsmEdit->meta_description}}@endif</textarea>
