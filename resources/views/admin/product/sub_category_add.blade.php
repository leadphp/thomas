    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        @include('partials/admin/msg')
                 <form name="csc-sub-category-save" method="post" action="{{ route('csc-sub-category-save')}}" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-10">
          <div class="toogle-wrap">
    <div class="togglebtn toggle-click">      
            <input type="button" class="solution_details cstm-accor" value="Sub Category Section">
...
<script type="text/javascript">
    ...
    function addrow(){
        ...
        $(".tile_body_img").append('<tr><td><p><input type="file" name="img[]" value=""></p><input type="hidden" name="spec_old_img[]" value=""></td><td><p><input type="text" name="spec_description[]" value=""></p></td><td><p><input type="text" name="price_per_domes[]" value=""></p></td><td><p><input type="text" name="domes_per_box[]" value=""></p></td><td><p><input type="text" name="spec_price[]" value=""></p></td><td><p><input type="text" name="tile_code[]" value=""></p></td><td class="inline-flex"><input type="button" class="add btn btn-primary" value="Add" onclick="tile_image();"><input type="button" class="remove btn btn-primary" value="Remove" onclick="$(this).parent().parent().remove();"></td></tr>');
