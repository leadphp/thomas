    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        <div class="box-header" style="cursor: move;">
                  <h3 class="box-title">CSC Detail Category</h3>
                  
                </div>
        
        @include('partials/admin/msg')
        <form name="csc-detail-update" method="post" action="{{ route('csc-detail-update')}}" enctype="multipart/form-data" >
        <div class="row">
            <div class="col-md-10">
          <div class="toogle-wrap">
          <div class="togglebtn toggle-click">
                <input type="button" class="solution_details cstm-accor" value="CSC Detail Category Section">
      ...
      <input type = "hidden" name = "id" value = "{{ $cat->id}}">
       ...
       @if ($errors->has('title')) 
        ...
        <label>Sub Category: </label>
         ...
         <?php $ids = explode(',',$cat->sub_category_id);
         ?>
        <select  name="sub_category" >
          @foreach($csc_sub_category as $product)
          ...
          <div class="table-responsive table-bordered">          
            <table class="table">
              ...
              <tbody class="tile_body">
                ...
                <tr>
                  <td><p><input type="text" name="size[]" value="{{$tile->size}}"></td>
