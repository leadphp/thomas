    ...
    <aside class="right-side">
     <div class="content cstm-cms-data">
        ...
        <form name="csc-category-update" method="post" action="{{ route('csc-category-update')}}" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-10">
                ...
                <i class="fa fa-plus solution_details"></i>
					...
					<div class="cstm-solution">
						...
						<input type = "hidden" name = "csc_type_old" value = "{{ $product_edit->csc_type}}">

						<div class="form-group">
							<label>Title: </label>
							<input type="text" name="title" value="@if ($errors->has('title')){{old('title')}}@else{{$product_edit->title}}@endif">
						   @if ($errors->has('title')) 
						...
						<div class="form-group">
							...
							<input class="csc_type" type="radio" id="single" name="csc_type" value="single" @if($product_edit->csc_type == 'single') checked @endif >Single 
  							<input class="csc_type" id="only" type="radio" name="csc_type" value="only" @if($product_edit->csc_type == 'only') checked @endif > Only<br>
			
						</div>

						<div class="form-group">
							<label>Price: </label>
							<input type="text" name="price" value="@if ($errors->has('price')){{old('price')}}@else{{$product_edit->price}}@endif">
						   @if ($errors->has('price')) 
								<label class="invalid-feedback label error" role="alert">
									{{ $errors->first('price') }}
								</label>
						...
						<div class="form-group">
							...
							<div class="row">
							<div class="col-md-6">
							 <img src="{{ asset('public/images/product/banner/'.$product_edit->banner_image) }}" class="tt">
							 <input type = "hidden" name ="old_banner_img" value ="{{$product_edit->banner_image}}">
							</div>
							<div class="col-md-6">
							<img id="blah1" src="#"  />
							<br>
						...
						<div class="form-group">
							...
							<input type="text" name="alt_banner_image" value="@if ($errors->has('alt_banner_image')){{old('alt_banner_image')}}@else{{$product_edit->alt_banner_image}}@endif">
						...
						<div class="form-group">
							...
							<textarea rows="4" cols="50" name="description"> @if ($errors->has('description')){{old('description')}}@else{{$product_edit->description}}@endif </textarea>
						...
						<div class="form-group">
							...
							<div class="row">
							<div class="col-md-6">
							<img src="{{ asset('public/images/product/'.$product_edit->image) }}" class="tt">
							<input type = "hidden" name = "old_img" value ="{{$product_edit->image}}">
							</div>
							<div class="col-md-6">
							<img id="blah" src="#"  />
								<br>
						...
						<input type="text" name="image_alt" value="@if ($errors->has('image_alt')){{old('image_alt')}}@else{{$product_edit->image_alt}}@endif">
					   @if ($errors->has('image_alt')) 
						...
						@endif 
							...
							<textarea rows="4" cols="50" name="product_features"> @if ($errors->has('product_features'))display_none{{old('product_features')}}@else{{$product_edit->product_features}}@endif </textarea>
						...
						<div class="form-group display_none">
							...
							<textarea rows="4" cols="50" name="size_price"> @if ($errors->has('size_price')){{old('size_price')}}@else{{$product_edit->size_price}}@endif </textarea>
						...
						<div class="form-group display_none">
							...
							<textarea rows="4" cols="50" name="application"> @if ($errors->has('application')){{old('application')}}@else{{$product_edit->application}}@endif </textarea>
						...
						<div class="form-group">
							...
							<input type="text" name="meta_title" value="@if ($errors->has('meta_title')){{old('meta_title')}}@else{{$product_edit->meta_title}}@endif" >
						...
						<textarea rows="4" cols="50" name="meta_description"> @if ($errors->has('meta_description')){{old('meta_description')}}@else{{$product_edit->meta_description}}@endif </textarea>
						...
						<input type="text" name="meta_keyword" value="@if ($errors->has('meta_keyword')){{old('meta_keyword')}}@else{{$product_edit->meta_keyword}}@endif">
					...
					<div class="table-responsive table-bordered">          
						<table class="table">
							...
							<tbody class="tile_body">
								<?php  $i=1 ?>
								@if($tiles_specification->isEmpty())
