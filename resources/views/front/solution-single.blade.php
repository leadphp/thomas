		...
		<div class="row">
				<div class="col-md-12">
					...
					<ul class="sublist">
						...
						<li class="sublist-active">Solutions</li>
						<li class="sublist-active">Single</li>
						<li>{{$data->title}}</li>
					</ul>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-8">
				<img src="{{ asset('public/images/admin/solution/'.$data->image) }}" class="img-responsive" alt="{{$data->image_alt}}">
						<div class="cast-text">					
						<h2>{{$data->title}}</h2>
						<h2>{{$data->price}}</h3>
						</div>
