		...
		<div class="row">
				...
				<aside>
					<ul>
						...
						?> 
						<li>
							<a href="{{url('solution/'.$solution->slug) }}"><div class="text-drop @if($solution->title == $data->title){{'active'}}@endif">{{$solution->title}}</div></a> 
							<a class="dropdown-btn togglebtn @if($solution->title == $data->title){{'active-dropbtn'}}@endif">
								<i class="fa fa-plus"></i>
							</a>
							<div class="dropdown-container @if($solution->title == $data->title){{'active-container'}}@endif">
